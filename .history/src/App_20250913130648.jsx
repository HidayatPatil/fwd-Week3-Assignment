  ...
  return (
    <div className="app_body">
      ...
      <div className="book_listing">
        ...
        <Book image="public/assets/book1.png" author="David Nixon" link="https://itbook.store/books/9781484256381" />
        <Book image="public/assets/book2.png" author="Janine Suvak" link="https://itbook.store/books/9781430265863" />
      </div>
